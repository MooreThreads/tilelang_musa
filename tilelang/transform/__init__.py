...
def RewriteMUSAPartialSync():
    """Rewrite partial sync to MUSA barrier synchronization."""
    return _ffi_api.RewriteMUSAPartialSync() if hasattr(_ffi_api, "RewriteMUSAPartialSync") else lambda f: f  # type: ignore
