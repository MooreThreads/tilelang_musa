...
TL_DEVICE void cp_async_gs(void const *const smem_addr, void *global_ptr) {
  __musa_memcpy_g2s((void _AS3 *)smem_addr, (void _AS1 *)global_ptr,
...
template <int N>
TL_DEVICE void cp_async_gs_robust(void const *const smem_addr, void *global_ptr,
                                  void const *robust_base_ptr,
                                  uint64_t robust_size) {
  auto robust_desc = make_robust_desc(robust_base_ptr, robust_size);
  __musa_memcpy_g2s_robust_v4((void _AS3 *)smem_addr, (void _AS1 *)global_ptr,
